    ...
    return (
        <>
            <OptionButton isEnabled={isButtonEnabled} onClick={handleToggle}>
                ...
                <OptionMenuToggleButton isActive={isButtonEnabled} isEnabled={menuShow} onClick={handleToggleOpenMenu}>
                    <span>
...
export default function UserDeviceSettings() {
    ...
    const handleToggleMenu = (setFunction) => {
        setFunction();
        if (audioMenuShow) setCameraMenuShow(false);
        else if (cameraMenuShow) setAudioMenuShow(false);
    }
