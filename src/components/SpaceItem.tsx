...
width: auto;
    ...
    font-size: 15px;
    color: rgb(255, 255, 255) !important;
    background-color: ${props => (props.active ? 'rgb(84, 92, 143)' : 'transparent')};
    ...
    return (
        <Container>
            <MapDisplay onMouseEnter={() => setEnterSpaceVisible(true)} onMouseLeave={() => setEnterSpaceVisible(false)}>
                ...
                <SpaceMapTopDetails>
                    <OnlineUsersDetail>
                        <FiberManualRecordRoundedIcon style={{ width: '18px', height: '18px', marginRight: '4px', color: 'rgb(6,214,160)' }} />
                        <span style={{ color: 'rgb(255, 255, 255)', fontFamily: "'DM Sans', sans-serif", fontWeight: 700, fontSize: '14px', lineHeight: '18px' }}>11</span>
                    </OnlineUsersDetail>
                </SpaceMapTopDetails>
                <EnterSpaceContainer style={{ opacity: isEnterSpaceVisible ? 1 : 0 }}>
                    <EnterSpaceButton>
                        <span><LoginRoundedIcon /></span>
                    </EnterSpaceButton>
                </EnterSpaceContainer>
            </MapDisplay>
            <DetailsDisplay>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <DetailsOptionButton active={isOptionPopupShow} onClick={handleButtonClick}><span><MoreVertRoundedIcon /></span></DetailsOptionButton>
                    </div>
                </div>
                {
                    isOptionPopupShow &&
