...
export const CreateSpacePopup: React.FC<PopupProps> = ({ onClosePopup }) => {
    ...
    return (
        <FormPopup onClose={onClosePopup} titles={titles} forms={PopupContents} totalSteps={totalSteps} formCanBeSubmit={formComplete} onSubmit={submitForm} submitText='Create space' />
    )
}
